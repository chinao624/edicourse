...
<body class="bg-gray-100">
    <div class="container mx-auto p-4 mt-8 mb-8" style="max-width: 800px;">
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <h2 class="text-2xl font-bold mb-6">コメントを投稿</h2>
            <form action="{{ route('article.comment.store', $article) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="comment" id="comment" rows="5" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('comment') border-red-500 @enderror" required>{{ old('comment') }}</textarea>
                    @error('comment')
